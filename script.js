document.addEventListener('DOMContentLoaded', () => {
        ...
        if ("geolocation" in navigator) {
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    // In a real app, you would use this to get a location name via a reverse geocoding API
    ...
    yieldForm.addEventListener('submit', (e) => {
        ...
        const randomYield = Math.floor(Math.random() * (1500 - 800 + 1)) + 800; // Random yield between 800 and 1500 kg
        ...
        const data = [
            ...
            Math.floor(Math.random() * 80) + 20, 
            Math.floor(Math.random() * 80) + 20, 
            randomYield / 20 // Scale for graph
        ];
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            ...
                            'rgba(255, 159, 64, 0.6)',
                            'rgba(76, 175, 80, 1)' // Primary green for the final prediction
                        ],
                        borderColor: [
                            'rgba(75, 192, 192, 1)',
                            'rgba(153, 102, 255, 1)',
    ...
    const translations = {
        en: {
            ...
            input_title: 'Enter Farm Details',
            form_label_location: 'Farm Location',
            form_button_gps: 'Use GPS',
            form_label_size: 'Farm Size',
            unit_acres: 'Acres',
            unit_hectares: 'Hectares',
            unit_sq_m: 'Sq. Meters',
            form_label_soil_known: 'Do you know the soil type?',
            form_label_yes: 'Yes',
            form_label_no: 'No',
            form_label_soil_type: 'Soil Type',
            form_label_soil_color: 'Soil Color',
            form_label_absorption: 'Absorption Rate',
            form_option_select: 'Select...',
            soil_clay: 'Clay',
            soil_sandy: 'Sandy',
            soil_loamy: 'Loamy',
            soil_silty: 'Silty',
            ...
            rate_medium: 'Medium',
            rate_low: 'Low',
            form_label_seed: 'Seed Type / Crop',
            form_label_date: 'Sowing Date',
            form_label_irrigation: 'Irrigation Method',
            method_drip: 'Drip Irrigation',
            method_sprinkler: 'Sprinkler Irrigation',
            method_flood: 'Flood Irrigation',
            form_button_predict: 'Predict Yield',
            dashboard_title: 'Prediction Dashboard',
            yield_heading: 'Expected Yield',
            yield_unit: 'kg',
            tips_heading: 'Resource Optimization Tips',
            tip_1: 'Use organic fertilizers to improve soil health.',
            tip_2: 'Install a drip irrigation system to save water.',
            tip_3: 'Monitor local weather forecasts for timely actions.',
            analysis_heading: 'Yield Analysis Graph',
            knowledge_title: 'Knowledge Hub',
            kh_card1_title: 'Understanding Soil Health',
            ...
            contact_info_text: 'For any queries, please reach out to **Team Crop Mitra**.',
            contact_email_label: 'Email:',
            contact_phone_label: 'Phone:',
            chatbot_button: 'Chat with Mitra',
            chatbot_header_text: 'Crop Mitra Chatbot',
            chatbot_input_placeholder: 'Type your message...',
            chatbot_send: 'Send',
            bot_welcome: 'Hello! How can I help you with your farming today?',
        ...
        hi: {
            ...
            home_button: 'शुरू करें',
            input_title: 'खेत का विवरण दर्ज करें',
            form_label_location: 'खेत का स्थान',
            form_button_gps: 'जीपीएस का उपयोग करें',
            form_label_size: 'खेत का आकार',
            unit_acres: 'एकड़',
            unit_hectares: 'हेक्टेयर',
            unit_sq_m: 'वर्ग मीटर',
            form_label_soil_known: 'क्या आप मिट्टी का प्रकार जानते हैं?',
            form_label_yes: 'हाँ',
            form_label_no: 'नहीं',
            form_label_soil_type: 'मिट्टी का प्रकार',
            form_label_soil_color: 'मिट्टी का रंग',
            form_label_absorption: 'अवशोषण दर',
            form_option_select: 'चुनें...',
            soil_clay: 'क्ले',
            soil_sandy: 'रेतीली',
            soil_loamy: 'लोमी',
            soil_silty: 'सिल्टी',
            ...
            rate_medium: 'मध्यम',
            rate_low: 'निम्न',
            form_label_seed: 'बीज का प्रकार / फसल',
            form_label_date: 'बुवाई की तारीख',
            form_label_irrigation: 'सिंचाई विधि',
            method_drip: 'ड्रिप सिंचाई',
            method_sprinkler: 'स्प्रिंकलर सिंचाई',
            method_flood: 'फ्लड सिंचाई',
            form_button_predict: 'उपज का पूर्वानुमान करें',
            dashboard_title: 'पूर्वानुमान डैशबोर्ड',
            yield_heading: 'अनुमानित उपज',
            yield_unit: 'किलोग्राम',
            tips_heading: 'संसाधन अनुकूलन युक्तियाँ',
            tip_1: 'मिट्टी के स्वास्थ्य को बेहतर बनाने के लिए जैविक उर्वरकों का उपयोग करें।',
            tip_2: 'पानी बचाने के लिए ड्रिप सिंचाई प्रणाली स्थापित करें।',
            tip_3: 'समय पर कार्रवाई के लिए स्थानीय मौसम के पूर्वानुमान की निगरानी करें।',
            analysis_heading: 'उपज विश्लेषण ग्राफ',
            knowledge_title: 'ज्ञान केंद्र',
            kh_card1_title: 'मिट्टी के स्वास्थ्य को समझना',
            ...
            contact_info_text: 'किसी भी प्रश्न के लिए, कृपया **टीम फसल मित्र** से संपर्क करें।',
            contact_email_label: 'ईमेल:',
            contact_phone_label: 'फ़ोन:',
            chatbot_button: 'मित्र से चैट करें',
            chatbot_header_text: 'फसल मित्र चैटबॉट',
            chatbot_input_placeholder: 'अपना संदेश टाइप करें...',
            chatbot_send: 'भेजें',
            bot_welcome: 'नमस्ते! मैं आज आपकी खेती में कैसे मदद कर सकता हूँ?',
        ...
        // Add translations for other languages here (ta, te, bn, mr, gu)
        // ...
        ta: {
            home: 'முகப்பு',
            input: 'உள்ளீடு',
            ...
            home_button: 'தொடங்கவும்',
            input_title: 'பண்ணை விவரங்களை உள்ளிடவும்',
            form_label_location: 'பண்ணை இருப்பிடம்',
            form_button_gps: 'ஜிபிஎஸ் பயன்படுத்தவும்',
            form_label_size: 'பண்ணை அளவு',
            unit_acres: 'ஏக்கர்',
            unit_hectares: 'ஹெக்டேர்',
            unit_sq_m: 'சதுர மீட்டர்கள்',
            form_label_soil_known: 'மண் வகை உங்களுக்குத் தெரியுமா?',
            form_label_yes: 'ஆம்',
            form_label_no: 'இல்லை',
            form_label_soil_type: 'மண் வகை',
            form_label_soil_color: 'மண் நிறம்',
            form_label_absorption: 'உறிஞ்சும் திறன்',
            form_option_select: 'தேர்ந்தெடுக்கவும்...',
            soil_clay: 'களிமண்',
            soil_sandy: 'மணல்',
            soil_loamy: 'வண்டல்',
            soil_silty: 'மண்டல்',
            ...
            color_grey: 'சாம்பல்',
            rate_high: 'அதிகம்',
            rate_medium: 'நடுத்தரம்',
            rate_low: 'குறைவு',
            form_label_seed: 'விதை வகை / பயிர்',
            form_label_date: 'விதைக்கும் தேதி',
            form_label_irrigation: 'நீர்ப்பாசன முறை',
            method_drip: 'சொட்டுநீர் பாசனம்',
            method_sprinkler: 'தெளிப்பு நீர்ப்பாசனம்',
            method_flood: 'வெள்ளப் பாசனம்',
            form_button_predict: 'விளைச்சலை கணிக்கவும்',
            dashboard_title: 'கணிப்பு டாஷ்போர்டு',
            yield_heading: 'எதிர்பார்க்கப்படும் விளைச்சல்',
            yield_unit: 'கிலோ',
            tips_heading: 'வள மேம்பாட்டு குறிப்புகள்',
            tip_1: 'மண் ஆரோக்கியத்தை மேம்படுத்த இயற்கை உரங்களைப் பயன்படுத்தவும்.',
            tip_2: 'தண்ணீரை சேமிக்க சொட்டுநீர் பாசன அமைப்பை நிறுவவும்.',
            tip_3: 'சரியான நேரத்தில் நடவடிக்கைகளை எடுக்க உள்ளூர் வானிலை முன்னறிவிப்புகளை கண்காணிக்கவும்.',
            analysis_heading: 'விளைச்சல் பகுப்பாய்வு வரைபடம்',
            knowledge_title: 'அறிவு மையம்',
            kh_card1_title: 'மண் ஆரோக்கியத்தைப் புரிந்துகொள்ளுதல்',
            ...
            contact_info_text: 'எந்தவொரு கேள்விகளுக்கும், தயவுசெய்து **குரூப் மித்ரா** குழுவைத் தொடர்பு கொள்ளவும்.',
            contact_email_label: 'மின்னஞ்சல்:',
            contact_phone_label: 'தொலைபேசி:',
            chatbot_button: 'மித்ராவுடன் அரட்டையடிக்கவும்',
            chatbot_header_text: 'கிராப் மித்ரா சாட்பாட்',
            chatbot_input_placeholder: 'உங்கள் செய்தியை உள்ளிடவும்...',
            chatbot_send: 'அனுப்பு',
            bot_welcome: 'வணக்கம்! இன்று உங்கள் விவசாயத்தில் நான் எப்படி உதவ முடியும்?',
        ...
        te: {
            ...
            home_button: 'ప్రారంభించండి',
            input_title: 'పొలం వివరాలను నమోదు చేయండి',
            form_label_location: 'పొలం స్థానం',
            form_button_gps: 'GPS ఉపయోగించండి',
            form_label_size: 'పొలం పరిమాణం',
            unit_acres: 'ఎకరాలు',
            unit_hectares: 'హెక్టార్లు',
            unit_sq_m: 'చదరపు మీటర్లు',
            form_label_soil_known: 'మీకు మట్టి రకం తెలుసా?',
            form_label_yes: 'అవును',
            form_label_no: 'లేదు',
            form_label_soil_type: 'మట్టి రకం',
            form_label_soil_color: 'మట్టి రంగు',
            form_label_absorption: 'శోషణ రేటు',
            form_option_select: 'ఎంచుకోండి...',
            soil_clay: 'బంకమట్టి',
            soil_sandy: 'ఇసుక',
            soil_loamy: 'లోమీ',
            soil_silty: 'సిల్టీ',
            soil_chalky: 'సున్నపురాయి',
            soil_peaty: 'పీటీ',
            color_black: 'నలుపు',
            color_brown: 'గోధుమ',
            color_red: 'ఎరుపు',
            color_yellow: 'పసుపు',
            color_grey: 'బూడిదరంగు',
            rate_high: 'అధిక',
            rate_medium: 'మధ్యస్థ',
            rate_low: 'తక్కువ',
            form_label_seed: 'విత్తన రకం / పంట',
            form_label_date: 'విత్తే తేదీ',
            form_label_irrigation: 'నీటిపారుదల పద్ధతి',
            method_drip: 'డ్రిప్ నీటిపారుదల',
            method_sprinkler: 'స్ప్రింక్లర్ నీటిపారుదల',
            method_flood: 'ఫ్లడ్ నీటిపారుదల',
            form_button_predict: 'దిగుబడిని అంచనా వేయండి',
            dashboard_title: 'అంచనా డాష్‌బోర్డ్',
            yield_heading: 'ఆశించిన దిగుబడి',
            yield_unit: 'కిలోలు',
            tips_heading: 'వనరుల ఆప్టిమైజేషన్ చిట్కాలు',
            tip_1: 'మట్టి ఆరోగ్యాన్ని మెరుగుపరచడానికి సేంద్రీయ ఎరువులను ఉపయోగించండి.',
            tip_2: 'నీటిని ఆదా చేయడానికి డ్రిప్ ఇరిగేషన్ వ్యవస్థను ఏర్పాటు చేయండి.',
            tip_3: 'సకాలంలో చర్యల కోసం స్థానిక వాతావరణ అంచనాలను పర్యవేక్షించండి.',
            analysis_heading: 'దిగుబడి విశ్లేషణ గ్రాఫ్',
            knowledge_title: 'నాలెడ్జ్ హబ్',
            kh_card1_title: 'మట్టి ఆరోగ్యాన్ని అర్థం చేసుకోవడం',
            ...
            contact_info_text: 'ఏవైనా ప్రశ్నల కోసం, దయచేసి **టీమ్ క్రాప్ మిత్రా**ను సంప్రదించండి.',
            contact_email_label: 'ఇమెయిల్:',
            contact_phone_label: 'ఫోన్:',
            chatbot_button: 'మిత్రాతో చాట్ చేయండి',
            chatbot_header_text: 'క్రాప్ మిత్రా చాట్‌బాట్',
            chatbot_input_placeholder: 'మీ సందేశాన్ని టైప్ చేయండి...',
            chatbot_send: 'పంపండి',
            bot_welcome: 'నమస్కారం! నేను ఈరోజు మీ వ్యవసాయంలో ఎలా సహాయపడగలను?',
        ...
        bn: {
            ...
            home_button: 'শুরু করুন',
            input_title: 'খামারের বিবরণ লিখুন',
            form_label_location: 'খামারের অবস্থান',
            form_button_gps: 'জিপিএস ব্যবহার করুন',
            form_label_size: 'খামারের আকার',
            unit_acres: 'একর',
            unit_hectares: 'হেক্টর',
            unit_sq_m: 'বর্গ মিটার',
            form_label_soil_known: 'আপনি কি মাটির ধরণ জানেন?',
            form_label_yes: 'হ্যাঁ',
            form_label_no: 'না',
            form_label_soil_type: 'মাটির ধরণ',
            form_label_soil_color: 'মাটির রঙ',
            form_label_absorption: 'শোষণ হার',
            form_option_select: 'নির্বাচন করুন...',
            soil_clay: 'কাদামাটি',
            soil_sandy: 'বেলে',
            soil_loamy: 'লোমি',
            soil_silty: 'পলি',
            ...
            rate_medium: 'মাঝারি',
            rate_low: 'নিম্ন',
            form_label_seed: 'বীজ / ফসলের ধরণ',
            form_label_date: 'বীজ বপনের তারিখ',
            form_label_irrigation: 'সেচ পদ্ধতি',
            method_drip: 'ড্রিপ সেচ',
            method_sprinkler: 'স্প্রিংকলার সেচ',
            method_flood: 'বন্যা সেচ',
            form_button_predict: 'উৎপাদন পূর্বাভাস করুন',
            dashboard_title: 'পূর্বাভাস ড্যাশবোর্ড',
            yield_heading: 'প্রত্যাশিত উৎপাদন',
            yield_unit: 'কেজি',
            tips_heading: 'সম্পদ অপটিমাইজেশন টিপস',
            tip_1: 'মাটির স্বাস্থ্য উন্নত করতে জৈব সার ব্যবহার করুন।',
            tip_2: 'পানি সাশ্রয় করতে ড্রিপ সেচ ব্যবস্থা স্থাপন করুন।',
            tip_3: 'সময় মতো পদক্ষেপ নিতে স্থানীয় আবহাওয়ার পূর্বাভাস পর্যবেক্ষণ করুন।',
            analysis_heading: 'উৎপাদন বিশ্লেষণ গ্রাফ',
            knowledge_title: 'জ্ঞান কেন্দ্র',
            kh_card1_title: 'মাটির স্বাস্থ্য বোঝা',
            ...
            contact_info_text: 'যেকোনো প্রশ্নের জন্য, অনুগ্রহ করে **টিম ক্রপ মিত্রা**-এর সাথে যোগাযোগ করুন।',
            contact_email_label: 'ইমেল:',
            contact_phone_label: 'ফোন:',
            chatbot_button: 'মিত্রার সাথে চ্যাট করুন',
            chatbot_header_text: 'ক্রপ মিত্রা চ্যাটবট',
            chatbot_input_placeholder: 'আপনার বার্তা লিখুন...',
            chatbot_send: 'পাঠান',
            bot_welcome: 'নমস্কার! আমি আজ আপনার কৃষিকাজে কীভাবে সাহায্য করতে পারি?',
        ...
        mr: {
            ...
            home_button: 'सुरु करा',
            input_title: 'शेताचे तपशील भरा',
            form_label_location: 'शेताचे स्थान',
            form_button_gps: 'जीपीएस वापरा',
            form_label_size: 'शेताचा आकार',
            unit_acres: 'एकर',
            unit_hectares: 'हेक्टर',
            unit_sq_m: 'चौ. मीटर',
            form_label_soil_known: 'तुम्हाला मातीचा प्रकार माहित आहे का?',
            form_label_yes: 'होय',
            form_label_no: 'नाही',
            form_label_soil_type: 'मातीचा प्रकार',
            form_label_soil_color: 'मातीचा रंग',
            form_label_absorption: 'शोषणाचा दर',
            form_option_select: 'निवडा...',
            soil_clay: 'चिकणमाती',
            soil_sandy: 'वाळूमय',
            soil_loamy: 'पोयटामाती',
            soil_silty: 'गाळाची माती',
            soil_chalky: 'खडूची माती',
            soil_peaty: 'पीटी',
            color_black: 'काळा',
            color_brown: 'तपकिरी',
            color_red: 'लाल',
            ...
            rate_medium: 'मध्यम',
            rate_low: 'निम्न',
            form_label_seed: 'बियाणे / पिकाचा प्रकार',
            form_label_date: 'पेरणीची तारीख',
            form_label_irrigation: 'सिंचन पद्धत',
            method_drip: 'ठिबक सिंचन',
            method_sprinkler: 'तुषार सिंचन',
            method_flood: 'पूर सिंचन',
            form_button_predict: 'उत्पादनाचा अंदाज घ्या',
            dashboard_title: 'अंदाज डॅशबोर्ड',
            yield_heading: 'अपेक्षित उत्पादन',
            yield_unit: 'किलो',
            tips_heading: 'संसाधन ऑप्टिमायझेशन टिपा',
            tip_1: 'मातीचे आरोग्य सुधारण्यासाठी सेंद्रिय खतांचा वापर करा.',
            tip_2: 'पाणी वाचवण्यासाठी ठिबक सिंचन प्रणाली स्थापित करा.',
            tip_3: 'वेळेवर कृती करण्यासाठी स्थानिक हवामानाचा अंदाज तपासा.',
            analysis_heading: 'उत्पादन विश्लेषण ग्राफ',
            knowledge_title: 'ज्ञान केंद्र',
            kh_card1_title: 'मातीचे आरोग्य समजून घेणे',
            ...
            contact_info_text: 'कोणत्याही प्रश्नांसाठी, कृपया **टीम पीक मित्रा**शी संपर्क साधा.',
            contact_email_label: 'ईमेल:',
            contact_phone_label: 'फोन:',
            chatbot_button: 'मित्रासोबत चॅट करा',
            chatbot_header_text: 'पीक मित्रा चॅटबॉट',
            chatbot_input_placeholder: 'तुमचा संदेश टाइप करा...',
            chatbot_send: 'पाठवा',
            bot_welcome: 'नमस्कार! मी आज तुम्हाला तुमच्या शेतीत कशी मदत करू शकेन?',
        ...
        gu: {
            ...
            home_button: 'શરૂ કરો',
            input_title: 'ખેતરની વિગતો દાખલ કરો',
            form_label_location: 'ખેતરનું સ્થાન',
            form_button_gps: 'જીપીએસનો ઉપયોગ કરો',
            form_label_size: 'ખેતરનું કદ',
            unit_acres: 'એકર',
            unit_hectares: 'હેક્ટર',
            unit_sq_m: 'ચો. મીટર',
            form_label_soil_known: 'શું તમે જમીનનો પ્રકાર જાણો છો?',
            form_label_yes: 'હા',
            form_label_no: 'ના',
            form_label_soil_type: 'જમીનનો પ્રકાર',
            form_label_soil_color: 'જમીનનો રંગ',
            form_label_absorption: 'શોષણ દર',
            form_option_select: 'પસંદ કરો...',
            ...
            rate_medium: 'મધ્યમ',
            rate_low: 'નિમ્ન',
            form_label_seed: 'બીજ / પાકનો પ્રકાર',
            form_label_date: 'વાવણીની તારીખ',
            form_label_irrigation: 'સિંચાઈ પદ્ધતિ',
            method_drip: 'ડ્રીપ સિંચાઈ',
            method_sprinkler: 'સ્પ્રીંકલર સિંચાઈ',
            method_flood: 'પૂર સિંચાઈ',
            form_button_predict: 'ઉપજનું અનુમાન કરો',
            dashboard_title: 'અનુમાન ડેશબોર્ડ',
            yield_heading: 'અપેક્ષિત ઉપજ',
            yield_unit: 'કિલો',
            tips_heading: 'સંસાધન ઑપ્ટિમાઇઝેશન ટિપ્સ',
            tip_1: 'જમીનનું આરોગ્ય સુધારવા માટે જૈવિક ખાતરોનો ઉપયોગ કરો.',
            tip_2: 'પાણી બચાવવા માટે ડ્રીપ સિંચાઈ સિસ્ટમ ઇન્સ્ટોલ કરો.',
            tip_3: 'સમયસર પગલાં લેવા માટે સ્થાનિક હવામાનની આગાહીનું નિરીક્ષણ કરો.',
            analysis_heading: 'ઉપજ વિશ્લેષણ ગ્રાફ',
            knowledge_title: 'જ્ઞાન કેન્દ્ર',
            kh_card1_title: 'જમીનનું આરોગ્ય સમજવું',
            ...
            contact_info_text: 'કોઈપણ પ્રશ્નો માટે, કૃપા કરીને **ટીમ ક્રોપ મિત્રા**નો સંપર્ક કરો.',
            contact_email_label: 'ઈમેલ:',
            contact_phone_label: 'ફોન:',
            chatbot_button: 'મિત્રા સાથે ચેટ કરો',
            chatbot_header_text: 'ક્રોપ મિત્રા ચેટબોટ',
            chatbot_input_placeholder: 'તમારો સંદેશ લખો...',
            chatbot_send: 'મોકલો',
            bot_welcome: 'નમસ્કાર! આજે હું તમને તમારી ખેતીમાં કેવી રીતે મદદ કરી શકું?',
    ...
    function addMessage(message, sender) {
        ...
        if (sender === 'user') {
            ...
            messageDiv.textContent = translations[languageSwitcher.value][message];
        }
